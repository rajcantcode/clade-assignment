const MessageSquare = ({ color, state }: { color: string; state?: string }) => {
  return (
    <div className="relative">
      ...
      {state === "unfocus" && (
        <div className="notification-dot w-[6px] h-[6px] absolute bg-primary top-[-2px] right-[-2px] rounded-full"></div>
      )}
    </div>
  );
};
